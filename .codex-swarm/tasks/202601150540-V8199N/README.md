...
depends_on: []
tags: ["docs", "agents"]
commit: { hash: "a48753efe5edffad8916f398e7c01622dfbb5ff7", message: "✨ V8199N add SEO swarm specialist roles" }
comments:
  - { author: "ORCHESTRATOR", body: "verified: Added role playbooks + created SEO specialist agent profiles | details: validated via agentctl agents and JSON parsing." }
doc_version: 2
